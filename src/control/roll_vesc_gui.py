...
#########################################################################
    ...
    if gimbal_flag == 1:
        ...
        # G2_init = 383.31
        G2_init = 22.92
        # print('gimbal angle(deg): ', st_data[1][2])
        # print('gimbal angle error(deg): ', ((st_data[1][2] - G2_init)/6))
        # print('gimbal angle error(rad): ', ((st_data[1][2] - G2_init)/6)*DEG2RAD)
        # print('gimbal angular velocity(deg): ', st_data[1][3])
        # print('gimbal angular velocity(rad): ', st_data[1][3]*DEG2RAD)
        # print('##################################')
        ...
        # print(pos_gb_data*RAD2DEG*6 + G1_init)
        # print(pos_gb_data*RAD2DEG*6 + G2_init)
